    ...
    <div className="relative h-screen w-screen overflow-hidden bg-[#FAFAFA]">
      ...
      >
        <div className="flex h-full w-screen shrink-0 flex-col overflow-y-auto overflow-x-hidden">
          <header className="sticky top-0 z-50 flex h-16 shrink-0 items-center justify-between border-b border-slate-200 bg-white/90 px-6 shadow-sm backdrop-blur-md md:px-12">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="rounded-xl border border-slate-300 bg-white px-4 py-2 text-xs font-bold text-slate-700 shadow-sm transition-all hover:bg-slate-50 active:scale-95"
              >
                ĐĂNG NHẬP
              </button>
              <button
                ...
                className="rounded-xl bg-[#004785] px-5 py-2.5 text-xs font-black uppercase tracking-wider text-white shadow-md shadow-blue-900/10 transition-all hover:bg-[#0F172A] active:scale-95"
              >
                Dùng thử miễn phí
              </button>
            </div>
          ...
          <section className="relative shrink-0 overflow-hidden border-b border-slate-200 bg-white px-6 py-16 md:px-12 lg:py-24">
            <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 lg:grid-cols-12">
              <div className="space-y-6 text-left lg:col-span-6">
                <div className="inline-flex items-center gap-2 rounded-lg border border-blue-200 bg-blue-50 px-3 py-1 text-xs font-bold uppercase tracking-wider text-[#004785] shadow-sm">
                  <Sparkles size={14} className="fill-amber-500 text-amber-500" />
                  Phiên bản nền tảng quản trị thông minh 2026
                </div>

                <h1 className="text-3xl font-black leading-tight tracking-tight text-slate-900 md:text-5xl md:leading-[1.12]">
                ...
                <p className="max-w-xl text-sm font-medium leading-relaxed text-slate-500 md:text-base">
                  ...
                  tiền điểm bán.
                  <strong className="font-bold text-slate-800"> MetalERP</strong> tự động hóa toàn
                  diện quy trình kinh doanh từ điểm bán POS mượt mà đến hệ thống tối ưu hóa danh mục
                  tồn kho dựa trên dữ liệu trực quan.
                </p>
                ...
                <div className="flex w-full flex-col gap-3 pt-2 text-xs font-bold sm:w-auto sm:flex-row">
                  <button
                    type="button"
                    onClick={() => handleSmoothNavigate('/register')}
                    className="group flex items-center justify-center gap-1.5 rounded-xl bg-[#004785] px-8 py-3.5 tracking-wider text-white shadow-md shadow-blue-900/10 transition-all hover:bg-black active:scale-95"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => handleSmoothNavigate('/login')}
                    className="flex items-center justify-center rounded-xl border border-slate-300 bg-white px-8 py-3.5 text-slate-700 shadow-sm transition-all hover:border-slate-400 hover:bg-slate-50 active:scale-95"
                  >
                    ĐĂNG NHẬP NGAY
                  </button>
                </div>
              ...
              <div className="hidden w-full lg:col-span-6 lg:block">
                <div className="group relative flex aspect-[4/3] items-center justify-center overflow-hidden rounded-xl border border-slate-200 bg-slate-50 p-8 shadow-2xl">
            ...
            <div className="mx-auto max-w-7xl">
              <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-12">
                <div className="space-y-1.5 lg:col-span-4">
                  <span className="block font-mono text-[10px] font-black uppercase tracking-widest text-[#004785]">
                    Thế mạnh nền tảng
                  </span>
                ...
                <div className="grid grid-cols-1 gap-4 text-xs font-semibold leading-relaxed text-slate-600 sm:grid-cols-3 lg:col-span-8">
          ...
          <section className="shrink-0 bg-[#FAFAFA] px-6 py-16 md:px-12">
            <div className="mx-auto max-w-7xl">
              <div className="mb-10 text-left md:text-center">
                ...
                <p className="mt-3 font-mono text-xs font-bold uppercase tracking-widest text-slate-400">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                {VALUES.map((feature, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="group rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition-all duration-150 hover:border-[#004785] hover:shadow-md"
                    >
                      ...
                      <h3 className="mb-1.5 font-mono text-xs font-black uppercase tracking-wide text-slate-800">
                        {idx + 1}. {feature.title}
                      </h3>
          ...
          <footer className="shrink-0 border-t border-slate-200 bg-white py-6 text-xs font-bold tracking-wider text-slate-400">
            <div className="mx-auto flex max-w-7xl flex-col items-center justify-center gap-4 md:flex-row md:justify-between md:px-12">
              ...
              <span className="font-mono text-[10px] font-bold uppercase tracking-widest text-slate-400">
                © 2026 M.E.P METAL_ERP SYSTEM. TOÀN QUYỀN BẢO HỘ PHẦN MỀM CHUỒI CUNG ỨNG.
              </span>
            </div>
          </footer>
        </div>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center gap-3 text-center font-mono tracking-widest">
            <div className="h-6 w-6 animate-spin rounded-full border-2 border-white/40 border-t-white" />
            <span className="text-l text-center font-black uppercase tracking-widest text-blue-200">
              ĐANG TẢI...
            </span>
          </div>
        </div>
