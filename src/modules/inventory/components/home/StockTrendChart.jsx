    ...
    <div className="rounded-xl border border-slate-200 bg-white p-4 dark:border-[#333333] dark:bg-[#0f0f0f]">
      ...
      <div className="flex h-48 items-end justify-between gap-2 px-2">
        {inventoryTrend.map((item) => (
          <div
            key={item.day}
            className="group relative w-full cursor-pointer rounded-t-md bg-blue-100 transition-colors hover:bg-[#004785] dark:bg-blue-900/50"
      ...
      <div className="mt-3 flex justify-between px-2 text-[10px] font-bold text-slate-400 dark:text-[#808080]">
        {inventoryTrend.map((item) => (
