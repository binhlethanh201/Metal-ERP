      ...
      <header className="flex h-16 shrink-0 items-center justify-between gap-4 border-b border-slate-200 bg-white px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative" ref={dropdownRef}>
            {/* AVATAR: Đã đổi style giống PosHeader (Vòng tròn màu chứa chữ cái đầu) */}
            <button
              type="button"
            ...
            {isProfileOpen && (
              <div className="animate-fadeIn absolute right-0 top-full z-50 mt-2 w-48 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-xl">
