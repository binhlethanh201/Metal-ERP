    ...
    >
      ...
      <div className="mb-6 grid grid-cols-3 gap-4">
        <div className="rounded-xl border border-blue-100 bg-blue-50/50 p-4">
          ...
          <p className="mt-1 text-2xl font-bold text-blue-700">{productSummary.totalProducts}</p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        {/* Top by quantity */}
        <div>
          <h3 className="mb-3 text-sm font-bold text-slate-700">Top 10 bán chạy theo số lượng</h3>
              ...
              <div key={p.sku} className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-1 flex items-center gap-2">
                    ...
                    <span className="w-16 text-right text-[11px] font-bold text-slate-600">
        ...
        {/* Top by revenue */}
        <div>
          <h3 className="mb-3 text-sm font-bold text-slate-700">Top 10 doanh thu cao nhất</h3>
          <div className="space-y-2">
              ...
              <div key={p.sku} className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-1 flex items-center gap-2">
                    ...
                    <span className="w-28 text-right text-[11px] font-bold text-purple-600">
