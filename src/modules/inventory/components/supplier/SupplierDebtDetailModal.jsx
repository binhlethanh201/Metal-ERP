...
const getPoStatusLabel = (status) => {
  switch (status?.toUpperCase()) {
    case 'APPROVED':
      return { label: 'Đã duyệt', css: 'bg-blue-100 text-blue-700' };
    case 'COMPLETED':
      return { label: 'Hoàn tất', css: 'bg-emerald-100 text-emerald-700' };
    case 'PENDING':
      return { label: 'Chờ duyệt', css: 'bg-amber-100 text-amber-700' };
    case 'CANCELLED':
      return { label: 'Đã hủy', css: 'bg-red-100 text-red-700' };
    default:
      return { label: status, css: 'bg-slate-100 text-slate-700' };
  }
};
    ...
    <div className="animate-fade-in fixed inset-0 z-[200] flex items-center justify-center bg-slate-900/60 p-4">
      <div className="flex max-h-[90vh] w-full max-w-5xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl">
        ...
        <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50 px-6 py-4">
          <div>
            <h2 className="text-xl font-bold text-slate-900">Chi tiết công nợ chi tiết</h2>
            <p className="mt-1 inline-block rounded bg-blue-50 px-2 py-0.5 text-sm font-semibold text-blue-800">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-4 rounded-xl border border-slate-200 bg-white p-5 shadow-sm md:grid-cols-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-slate-400">Địa chỉ Email</p>
                    <p className="font-semibold text-slate-800">
              ...
              {/* Danh sách PO */}
              <div>
                <h3 className="mb-4 text-lg font-bold text-slate-800">Lịch sử đơn mua hàng</h3>
                          ...
                          <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50 px-5 py-4">
                            <div className="flex items-center gap-4">
                              <div>
                                ...
                                <p className="text-lg font-bold text-blue-700">{po.orderCode}</p>
                              </div>
                              <div>
                                <p className="text-xs font-medium text-slate-500">Ngày đặt</p>
