  ...
  return (
    <div className="animate-fade-in fixed inset-0 z-[200] flex items-center justify-center bg-slate-900/60 p-4">
      <div className="flex w-full max-w-lg flex-col overflow-hidden rounded-2xl bg-white shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 bg-slate-50/50 p-6">
          {error && (
          ...
          <div className="grid grid-cols-2 gap-4">
            <label className="block text-sm font-medium text-slate-700">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full rounded-xl border border-slate-300 px-3 py-2.5 font-bold text-slate-900 outline-none focus:border-blue-500"
