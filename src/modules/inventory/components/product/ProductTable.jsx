 ...
 * Nhận rows, sortConfig, getSortIcon, onToggleSort, expandedId, onToggleExpand, onEdit, onDelete.
 */
      ...
      <tr className="text-[11px] font-bold uppercase text-slate-600">
        ...
        {[
          ...
          >
            ...
            >
              <span>{label}</span>
              {sortKey && <MaterialIcon name={getSortIcon?.(sortKey)} className="text-[16px]" />}
            </div>
          </th>
        ))}
      </tr>
