  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex h-10 w-full items-center justify-between gap-2 rounded-xl border border-slate-200 bg-white px-3 text-sm transition-colors hover:bg-slate-50"
      >
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute left-0 top-full z-20 mt-1 w-full min-w-[150px] rounded-xl border border-slate-200 bg-white py-1 shadow-lg">
            {options.map((option) => (
              <button
                key={option.value}
                type="button"
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end">
        ...
        <div className="flex-1">
          <div className="relative">
            ...
            <input
              ...
              className="h-10 w-full rounded-xl border border-slate-200 bg-white pl-10 pr-4 text-sm outline-none transition-colors focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
            />
          </div>
        </div>
        ...
        {hasActiveFilters && (
          <button
            ...
            className="flex h-10 items-center gap-1 rounded-xl border border-slate-200 bg-white px-4 text-sm font-medium text-slate-600 transition-colors hover:bg-slate-50 hover:text-slate-900"
          >
            <X className="h-4 w-4" />
            Xóa lọc
          </button>
      ...
      {showAdvanced && (
        <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {/* Date From */}
            <div>
              <label className="mb-1.5 block text-xs font-medium text-slate-600">Từ ngày</label>
              <input
                type="date"
            ...
            {/* Date To */}
            <div>
              <label className="mb-1.5 block text-xs font-medium text-slate-600">Đến ngày</label>
              <input
                type="date"
            ...
            <div className="sm:col-span-2">
              <label className="mb-1.5 block text-xs font-medium text-slate-600">Người tạo</label>
              <input
                type="text"
