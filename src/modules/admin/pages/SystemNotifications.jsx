            ...
            <div className="flex justify-end gap-2 border-t border-slate-200 dark:border-[#333333] pt-2">
              {editingId && (
                <button
                  type="button"
                  onClick={resetForm}
                  className="rounded bg-slate-100 dark:bg-[#272727] px-3 py-2 text-xs font-bold hover:bg-slate-100 dark:bg-[#272727]est"
                >
                  Hủy
                </button>
              )}
        ...
        <div className="overflow-hidden rounded-xl border border-slate-200 dark:border-[#333333] bg-white dark:bg-[#0f0f0f] shadow-sm lg:col-span-2">
          <div className="flex items-center justify-between border-b border-slate-200 dark:border-[#333333] bg-slate-50 dark:bg-[#1a1a1a] px-4 py-3">
            ...
            <button
              ...
              className="hover:text-[#004785] dark:text-blue-400-variant text-[#004785] dark:text-blue-400"
            >
                  ...
                  {notifications.map((n) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <span
                            className={`rounded px-2 py-0.5 text-[9px] font-bold ${n.priority === 'HIGH' ? 'bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-500' : 'bg-slate-100 dark:bg-[#272727] text-slate-500 dark:text-[#999999]'}`}
                          >
                            {n.priority}
                          </span>
                        </td>
                            ...
                            {isDraft && (
                              <>
                                <button
                                  ...
                                  className="rounded p-1 text-[#004785] dark:text-blue-400 hover:bg-[#004785] dark:bg-blue-600-container"
                                  title="Gửi ngay"
                                >
                                ...
                                <button
                                  ...
                                  className="rounded p-1 text-slate-400 dark:text-[#666666] hover:bg-slate-100 dark:bg-[#272727] hover:text-slate-900 dark:text-[#e5e5e5]"
                                  title="Sửa"
                                >
