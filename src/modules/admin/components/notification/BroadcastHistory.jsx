    ...
    <div className="rounded-lg border border-outline-variant bg-surface-container-lowest p-5 shadow-sm">
      ...
      <div className="space-y-4">
        {historyData.map((bc) => (
          ...
          >
            <div
              className={`absolute -left-[5px] top-1.5 h-2 w-2 rounded-full border-2 border-surface-container-lowest ${bc.status === 'scheduled' ? 'bg-secondary' : 'bg-outline-variant'}`}
            />
            ...
            <div className="mb-1 flex items-center gap-2">
              ...
              <span className="font-mono text-[11px] font-medium text-outline">{bc.time}</span>
            </div>
            ...
            <div className="mt-1.5 flex items-center gap-1.5 text-[11px] font-semibold text-on-surface-variant">
              ...
              Target: <span className="text-on-surface">{bc.target}</span>
            </div>
          </div>
        ))}
