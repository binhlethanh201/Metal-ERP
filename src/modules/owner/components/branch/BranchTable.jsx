              ...
              branches.map((branch) => {
                ...
                return (
                  <React.Fragment key={branch.branchId}>
                    {/* Dòng dữ liệu chính */}
                    <tr
                      className={`transition-colors hover:bg-slate-50/60 ${isExpanded ? 'bg-blue-50/20' : ''}`}
                    >
                      ...
                      <td className="px-6 py-4">
                        ...
                        <div className="text-xs text-slate-400">{branch.type}</div>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4">
                        <div className="font-medium text-slate-700">{branch.managerFullName}</div>
                        <div className="text-xs text-slate-400">{branch.managerEmail}</div>
                      </td>
                      <td className="px-6 py-4">
                        <span
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex items-center justify-end gap-1">
                          ...
                          <button
                            ...
                            className={`rounded-lg p-2 transition-colors ${isExpanded ? 'bg-blue-600 text-white hover:bg-blue-700' : 'text-slate-500 hover:bg-slate-100'}`}
