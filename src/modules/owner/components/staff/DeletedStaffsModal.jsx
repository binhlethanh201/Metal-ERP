        ...
        <table className="w-full text-left text-sm text-slate-600">
          ...
          <tbody className="divide-y divide-slate-100">
            {deletedStaffs.map((staff) => (
              <tr key={staff.userId} className="transition-colors hover:bg-slate-50/60">
                ...
                <td className="px-6 py-4">
                  <div className="text-xs text-slate-400">{staff.phoneNumber || '---'}</div>
                </td>
                <td className="px-6 py-4">
                  <div className="text-slate-600">{formatDate(staff.deletedAt)}</div>
                </td>
                <td className="px-6 py-4">
                  <span
