    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">Bắt đầu và kết thúc ca làm việc</p>
        </div>
        {!isShiftActive ? (
      ...
      {isShiftActive && (
        <Card className="border border-[#004785]">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-bold text-slate-900">Ca làm việc đang mở</h2>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              ...
              <div>
                ...
                <p className="text-2xl font-extrabold text-[#004785]">24</p>
              </div>
              <div>
                <p className="text-[11px] font-bold uppercase tracking-[0.05em] text-slate-500">
                  Doanh số tạm thời
                </p>
                <p className="text-2xl font-extrabold text-green-600">{formatCurrency(4200000)}</p>
              </div>
            </div>
          </div>
        </Card>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        <Card>
          <div className="py-4 text-center">
            <div className="text-2xl font-extrabold text-[#004785]">{shifts.length}</div>
        ...
        <Card>
          <div className="py-4 text-center">
            <div className="text-2xl font-extrabold text-orange-600">8h</div>
            <p className="mt-1 text-[11px] font-bold uppercase tracking-[0.05em] text-slate-500">
              Tổng giờ
            </p>
          </div>
      ...
      <Card header="Lịch sử ca làm việc">
        <div className="space-y-3">
          {shifts.map((shift) => (
            <div key={shift.id} className="rounded-lg border border-slate-200 p-4">
              <div className="mb-3 flex items-start justify-between">
                <div>
                  <p className="font-bold text-slate-900">{shift.date}</p>
                  <p className="text-sm text-slate-500">{shift.cashier}</p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3 text-sm md:grid-cols-4">
                ...
                <div>
                  <p className="text-slate-500">Số dư đầu</p>
                  <p className="font-semibold text-slate-900">
                ...
                <div>
                  ...
                  <p className="font-semibold text-green-600">{formatCurrency(shift.totalSales)}</p>
                </div>
                <div>
                  <p className="text-slate-500">Số dư cuối</p>
                  <p className="font-semibold text-slate-900">
