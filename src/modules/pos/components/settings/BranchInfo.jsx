  ...
  return (
    <Card header="Thông tin chi nhánh">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
          <p className="text-xs font-bold uppercase tracking-[0.05em] text-slate-400">Địa chỉ</p>
        ...
        <div>
          <p className="text-xs font-bold uppercase tracking-[0.05em] text-slate-400">Mã số thuế</p>
