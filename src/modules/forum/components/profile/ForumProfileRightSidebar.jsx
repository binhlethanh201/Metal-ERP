...
const ForumProfileRightSidebar = () => (
  <div className="space-y-4">
    <section className="rounded-2xl bg-white p-4 shadow-sm">
      <h4 className="mb-3 text-xs font-black uppercase tracking-widest text-slate-400">Liên hệ</h4>
      <div className="space-y-2.5">
        <button
          type="button"
          className="flex w-full items-center gap-3 rounded-xl bg-[#004785] px-4 py-2.5 text-sm font-bold text-white transition-all hover:bg-black active:scale-95"
        >
