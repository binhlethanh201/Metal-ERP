/**
 * ForumLeftSidebar - Menu điều hướng trái, 4 nhóm chính.
 * DIỄN ĐÀN: Trang chủ, Tin tức ngành, Thảo luận, Bài viết của tôi, Bài đã lưu.
 * XU HƯỚNG  DỮ LIỆU: Xu hướng, Top bán chạy, SP mới, Biến động giá.
 * KẾT NỐI KINH DOANH: Nguồn hàng, Đăng bán giá sỉ.
 * QUẢN LÝ: Gợi ý nhập hàng.
 * Props: activeKey (xác định item nào đang active).
 */
