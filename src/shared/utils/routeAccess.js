...
export const ROUTE_PERMISSIONS = {
  ...
  inventoryProducts: ['PRODUCT_VIEW', 'PRODUCT_CREATE', 'PRODUCT_UPDATE', 'PRODUCT_DELETE', 'PRODUCT_CATEGORY_MANAGE'],
  ...
  inventoryCheck: ['STOCK_CHECK_VIEW', 'STOCK_CHECK_CREATE', 'STOCK_CHECK_COUNT', 'STOCK_CHECK_APPROVE', 'STOCK_CHECK_CANCEL'],
  ...
  supplierDebt: ['SUPPLIER_PAYMENT_VIEW', 'SUPPLIER_PAYMENT_CREATE', 'SUPPLIER_PAYMENT_DELETE'],
  supplierPayments: [
    'SUPPLIER_PAYMENT_VIEW',
    'SUPPLIER_PAYMENT_CREATE',
    'SUPPLIER_PAYMENT_UPDATE',
