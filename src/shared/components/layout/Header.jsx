      ...
      <div className="flex min-h-16 items-center justify-between gap-4 px-6 py-0">
        <div className="flex max-w-xl flex-1 items-center rounded-lg border border-slate-200 bg-slate-50 px-4 py-2 dark:border-[#404040] dark:bg-[#1a1a1a]">
          ...
          <input
            ...
            className="w-full border-none bg-transparent text-sm outline-none focus:ring-0 dark:text-[#d4d4d4] dark:placeholder:text-[#808080]"
          />
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <button
              type="button"
              className="relative rounded-lg p-2 text-slate-500 hover:bg-slate-100 dark:text-[#999999] dark:hover:bg-[#272727]"
            >
            ...
            <div className="flex items-center gap-3 pl-2">
              <img
                ...
                className="h-10 w-10 rounded-lg border border-slate-200 object-cover dark:border-[#404040]"
                src={
                  user?.avatar ||
